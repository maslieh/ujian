<div class="row col-md-12 ini_bodi">
    <div class="panel panel-info">
        <div class="panel-heading">Data Guru/Dosen
            <div class="tombol-kanan">
                ...
                <a class="btn btn-warning btn-sm tombol-kanan"
                    href="<?php echo base_url(); ?>upload/format_import_guru.xlsx"><i
        ...
        <div class="panel-body">
            <a href="#" onclick="return aktifkan_semua_guru();" class="btn btn-info" style="margin-bottom: 10px"><i
                    class="fa fa-users"></i> Aktifkan semua guru</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="myModalLabel">Data Guru/Dosen</h4>
            </div>
                ...
                <form name="f_guru" id="f_guru" onsubmit="return m_guru_s();">
                    ...
                    <table class="table table-form">
                        <tr>
                            ...
                            <td style="width: 75%"><input type="text" class="form-control" name="nip" id="nip" required>
                            </td>
                        </tr>
                        <tr>
