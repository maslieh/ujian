...
function gen_menu()
{
	...
	if ($sess_level == "guru") {
		...
		$menu = array(
			array("url" => "", "text" => "Dashboard"),
			array("url" => "m_siswa", "text" => "Data Siswa"),
			array("url" => "m_guru", "text" => "Data Guru/Dosen"),
			array("url" => "m_mapel", "text" => "Data Mapel"),
			array("url" => "m_soal", "text" => "Soal"),
			array("url" => "h_ujian", "text" => "Hasil Ujian"),
		);
	} else {
		$menu = array(
			array("url" => "", "text" => "Dashboard")
	...
	if ($menu != null) {
		...
		foreach ($menu as $m) {
			if ($url == $m['url']) {
				echo
					'<li>
<a href="' . base_url() . 'adm/' . $m['url'] . '"class="alert alert-danger">' . $m['text'] . '</a></li>';
			} else {
				echo
					'
<li><a href="' . base_url() . 'adm/' . $m['url'] . '"class="alert alert-info">' . $m['text'] . '</a></li>';
			}
		}
